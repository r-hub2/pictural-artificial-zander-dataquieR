...
#' @noRd
# nolint end
util_margins_poi <- function(resp_vars = NULL, group_vars = NULL, co_vars = NULL, # nolint: line_length_linter.
  ...
  ds1$resp_var_adj <-
    ...
    res_df$rate[match(ds1[[group_vars]], res_df[, group_vars, drop = TRUE])] +
