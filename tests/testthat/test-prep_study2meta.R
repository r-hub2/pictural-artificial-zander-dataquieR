test_that("prep_study2meta works", {
  skip_on_cran() # slow, rarely used, since w/o metdata, reports are not really informative # nolint: line_length_linter.
  ...
  reference <- data.frame(
    VAR_NAMES = colnames(cars),
    LABEL = colnames(cars),
    DATA_TYPE = "integer",
    SCALE_LEVEL = c(
      SCALE_LEVELS$ORDINAL, # this is not correctly guessed
      SCALE_LEVELS$RATIO
    ),
    UNIT = NA_character_,
  ...
  suppressWarnings(expect_warning(
    ...
    regexp =
      sprintf(
        "%s",
        paste(
          ".+study_data.+ looks like a tibble. However, the package",
...
test_that("prep_study2meta records ordered factor labels", {
  skip_on_cran()

  study_data <- data.frame(
    severity = ordered(c("low", "medium", "high"),
      levels = c("low", "medium", "high")
    )
  )

  meta_data <- prep_study2meta(
    study_data,
    cumulative = FALSE,
  ...
  expect_identical(meta_data[[VAR_NAMES]], "severity")
  expect_identical(meta_data[[VALUE_LABELS]], "low < medium < high")
  expect_identical(meta_data[[MISSING_LIST]], SPLIT_CHAR)
})
...
test_that("prep_study2meta works on study_data", {
  ...
  meta_data[
    meta_data$LABEL %in% c("SBP_0", "DBP_0", "ARM_CIRC_0", "BSG_0"),
    DATA_TYPE
  ] <- # values are not really float
    DATA_TYPES$INTEGER
  ...
  expect_equal(
    ...
    data.frame(
      ...
      MISSING_LIST = c(
        ...
        SPLIT_CHAR,
        SPLIT_CHAR,
        "99980|99981|99982|99983|99984|99985|99986|99987|99988|99989|99990|99991|99992|99993|99994|99995", # nolint: line_length_linter.
        "99980|99981|99982|99983|99984|99985|99986|99987|99988|99989|99990|99991|99992|99993|99994|99995", # nolint: line_length_linter.
        "99980|99983|99987|99988|99989|99990|99991|99992|99993|99994|99995",
        "99980|99988|99989|99991|99993|99994|99995",
        SPLIT_CHAR,
        "99980|99981|99982|99983|99984|99985|99986|99988|99989|99990|99991|99992|99993|99994|99995", # nolint: line_length_linter.
        "99980|99987",
        SPLIT_CHAR,
        SPLIT_CHAR,
        SPLIT_CHAR,
        "99980|99981|99982|99983|99984|99985|99986|99988|99989|99990|99991|99992|99994|99995", # nolint: line_length_linter.
        "99980|99981|99982|99983|99984|99985|99986|99988|99989|99990|99991|99992|99994|99995", # nolint: line_length_linter.
        SPLIT_CHAR,
        SPLIT_CHAR,
